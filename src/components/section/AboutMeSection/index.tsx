        ...
        <div className="internship">
          ...
          <div className="project">
            ...
            <ul className="project-description">
              <li>- 사용자의 입력이 문서에 반영될 때마다 시각적인 피드백 제공</li>
              <li>- 사용자로부터 정확한 형식의 데이터가 입력될 수 있도록 유효성 검사 구성</li>
            </ul>
          </div>
          <div className="project">
            <div className="project-title">
            ...
            <ul className="project-description">
              <li>- Gitlab runner를 사용하여 Gitlab CI/CD 파이프라인을 구축하고, 앱 실행 시 자동으로 버전 업데이트가 되도록 구현</li>
              <li>- 사용자에 의해 화면이 줄어들면 사분할의 VIEW 영역이 같은 비율로 줄어들어 깨짐이 없도록 반응형 구현</li>
              <li>- 데스크톱 앱 & 어드민 웹페이지 UI 구성</li>
            </ul>
          </div>
        </div>
      </motion.div>
